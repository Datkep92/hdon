// =======================
// MUAHANG.JS - SỬA XUNG ĐỘT  
// =======================

// Sử dụng hàm core thay vì định nghĩa lại
if (typeof window.unifiedRenderInvoices === 'function') {
    window.renderPurchaseInvoices = window.unifiedRenderInvoices;
}

// Giữ lại các hàm đặc thù của mua hàng
// viewPurchaseInvoiceDetail, editPurchaseInvoice, createPurchaseReceipt, etc.
